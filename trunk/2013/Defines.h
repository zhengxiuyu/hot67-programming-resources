...
#define CompetitionBot
	...
	#define PLATE_P -0.035
	#define PLATE_PYRAMID_THREE_POINT 589.0
	#define PLATE_PYRAMID_AUTON 592.0
	#define PLATE_FEEDER_THREE_POINT 547.0
	#define PLATE_FEEDER_TWO_POINT 527
	#define PLATE_TEN_POINT_CLIMB 275
